...
def init_cache():
    ...
    #model = Huggingface(model="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
    data_manager = get_data_manager(CacheBase("sqlite"), VectorBase("chromadb", dimension=model.dimension))
    cache.init(embedding_func=model.to_embeddings,
